...
def reverse_recursive(lst):
    ...
    if len(lst) == 0:
        ...
        # creating new list only last digit + recursively calling w/o the last digit
...
def distance(city_a, city_b):
    ...
    5.0
    """
    param1 = get_lat(city_a) - get_lat(city_b)
    param2 = get_lon(city_a) - get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    place = make_city('random', lat, lon)
    dis1 = distance(place, city_a)
    dis2 = distance(place, city_b)
