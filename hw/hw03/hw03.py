...
def g_iter(n):
    ...
    for _ in range(4, n + 1):
        next_value = g3 + 2 * g2 + 3 * g1

        g1, g2, g3 = g2, g3, next_value
    return g3
...
def missing_digits(n):
    ...
    if n < 10:
        ...
        last_digit = n % 10 
        before_last = (n // 10 ) % 10
        # checking how many digits miss between 
        missing_digit_res = max(0, last_digit - before_last - 1)

        # calling recursion， cumulated the res 
        return missing_digits( n // 10) + missing_digit_res
